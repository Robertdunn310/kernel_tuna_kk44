...
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
CFLAGS_KERNEL	= -march=armv7-a -mtune=cortex-a9 -marm -mcpu=cortex-a9 -mfpu=neon -mfloat-abi=soft -mvectorize-with-neon-quad -ffast-math
AFLAGS_KERNEL	= -march=armv7-a -mtune=cortex-a9 -marm -mcpu=cortex-a9 -mfpu=neon -mfloat-abi=soft -mvectorize-with-neon-quad -ffast-math
